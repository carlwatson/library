 ...
 */
?>
<header class="header-social-left">
  ...
  <div class="top-bar grid-x">
    ...
    <div class="utility-row small-12 large-6">
  ...
  <div class="second-top-bar grid-x">
    <div class="social-menu-block top-bar-menu small-12 medium-2 clearfix">
      <?php print drupal_render($sybase2_extras_social_menu); ?>
    </div>

    <div class="nav-row small-12 medium-10">
      <nav id="main-menu">
