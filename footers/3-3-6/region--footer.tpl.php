 ...
 */
?>
<footer id="footer" class="grid-container fluid footer-3-3-6">
  <div id="footer-inner" class="grid-x">
    ...
    <div class="footer-center footer-block small-12 medium-3">

      <?php print drupal_render($sy_multidomain_footer_center_two); ?>

    </div>

    <div class="footer-right footer-block small-12 medium-6">
