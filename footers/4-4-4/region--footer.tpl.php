 ...
 */
?>
<footer id="footer" class="grid-container fluid footer-4-4-4">
  <div id="footer-inner" class="grid-x">
    ...
    <div class="footer-left footer-block small-12 medium-4">

      <?php print drupal_render($sy_multidomain_footer_left_one); ?>

    </div>

    <div class="footer-center footer-block small-12 medium-4">

      <?php print drupal_render($sy_multidomain_footer_center_two); ?>

    </div>

    <div class="footer-right footer-block small-12 medium-4">
