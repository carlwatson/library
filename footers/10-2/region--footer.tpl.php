 ...
 */
?>
<footer id="footer" class="grid-container fluid footer-10-2">
  <div id="footer-inner" class="grid-x">
    ...
    <div class="footer-left footer-block small-12 medium-10">

      <?php print drupal_render($sy_multidomain_footer_left_one); ?>

    </div>

    <div class="footer-center footer-block small-12 medium-2">
